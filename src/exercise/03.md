...
- you need to tell babel to compile JSX in the browser by adding it to the page although in production setting you should pre-compile it
- write your jsx code that you want complied within the babel script tag
- the bable script tag tells the babel to compile the code and the browser not to touch it (since the type is not javascript or text/javascript)
- react and react-dom are separated so that react is not tied to the web brower i.e react native
